...
The address required to broadcast the message, for instance, a phone number or an FCM ID, is expected to be stored and relayed as [customer attributes](concepts.md/#attributes).
