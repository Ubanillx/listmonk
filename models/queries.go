...
type Queries struct {
	...
	UpsertWorkspaceSubscriber          *sqlx.Stmt `query:"upsert-workspace-subscriber"`
	UpsertWorkspaceBlocklistSubscriber *sqlx.Stmt `query:"upsert-workspace-blocklist-subscriber"`
