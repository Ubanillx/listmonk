...
var auditRoutes = map[string]auditRouteSpec{
	...
	"POST /api/profile/reply-mailboxes/:id/delete":       {"reply_mailbox.deleted", "reply_mailbox", "id"},
	...
	"PUT /api/organizations/:id/reply-mailbox":                 {"organization.reply_mailbox_changed", "organization", "id"},
