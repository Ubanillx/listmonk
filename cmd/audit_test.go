...
func TestAuditSecondPhaseRouteTaxonomy(t *testing.T) {
	want := map[string]string{
		...
		"POST /api/media/folders":                    "media_folder.created",
		"PUT /api/media/folders/:id":                 "media_folder.renamed",
		"PUT /api/media/folders/:id/move":            "media_folder.moved",
		"DELETE /api/media/folders/:id":              "media_folder.deleted",
		"PUT /api/media/:id/folder":                  "media.folder_changed",
